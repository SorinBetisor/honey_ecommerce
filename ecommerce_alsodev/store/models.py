...
class Customer(models.Model):
    ...
    def __str__(self):
        return str(f"{self.name}: {self.message}")
...
class Product(models.Model):
    ...
    articol=models.CharField(max_length=4, null=True)
...
class ShippingAddress(models.Model):
    ...
    # date_added= models.DateTimeField(max_length=200, null=False)

    def __str__(self):
        return str(f"{self.name} : {self.address1}")
